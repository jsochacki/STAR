...
[psd_figure psd_axis] = create_psd_plot([], [], ...
                ...
                20*log10(filtfilt(1./(100*ones(1,100)),1,abs(fftshift(fft(tx_waveform, length(tx_waveform)))))), ...
                linspace(-1/2, 1/2, length(tx_waveform_post_cfr)), ...
                20*log10(filtfilt(1./(100*ones(1,100)),1,abs(fftshift(fft(tx_waveform_post_cfr, length(tx_waveform_post_cfr)))))), ...
                [], ...
                [], ...
                oversampling_rate, ...
                -30, ...
